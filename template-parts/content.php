...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header pageCenterHeading">
		<?php
		if ( is_singular() ) :
		...
		if ( 'post' === get_post_type() ) :
			?>
			<div class="innerBlogCardHeaderItem">
				<svg fill="#707070" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 22"><g fill="none" fill-rule="evenodd" stroke="#707070" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="translate(1 1)"><rect width="18" height="18" y="2" rx="2"></rect><path d="M13 0v4M5 0v4M0 8h18"></path></g></svg>
